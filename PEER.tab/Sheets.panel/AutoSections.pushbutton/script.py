...
__author__ = 'Dmitry D'
__doc__ = ('Version = 5.0\n'
           'Build vertical sections at the windows of the ACTIVE level plan.\n\n'
           ...
           'Only UNIQUE nodes (wall thickness + slab thickness + spandrel height) '
           'get a real section; repeated nodes get a REFERENCE marker pointing at '
           'the first one.\n\n'
